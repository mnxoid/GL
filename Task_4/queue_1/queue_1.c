...
int main()
{
	...
	if (InputInt(&N,USELIM,0,MAXUI) == ERROR)
	 {
	 	printf("Error! Null pointer exception!\n");
	 	return 0;
	 }
	printf("Input the step: ");
	if (InputInt(&M,USELIM,0,N) == ERROR)
	 {
	 	printf("Error! Null pointer exception!\n");
	 	return 0;
	 }
	printf("Input the starting number: ");
	if (InputInt(&K,USELIM,0,N) == ERROR)
	 {
	 	printf("Error! Null pointer exception!\n");
	 	return 0;
	 }
	printf("Input the number of iterations: ");
	if (InputInt(&L,USELIM,0,MAXUI) == ERROR)
	 {
	 	printf("Error! Null pointer exception!\n");
	 	return 0;
	 }
